...
-define(FILEPATH, "src/gleam/otp/intensity_tracker.gleam").
...
-file("src/gleam/otp/intensity_tracker.gleam", 14).
-spec new(integer(), integer()) -> intensity_tracker().
new(Limit, Period) ->
    {intensity_tracker, Limit, Period, []}.

-file("src/gleam/otp/intensity_tracker.gleam", 21).
-spec now_seconds() -> integer().
now_seconds() ->
    erlang:monotonic_time(1).

-file("src/gleam/otp/intensity_tracker.gleam", 25).
...
-file("src/gleam/otp/intensity_tracker.gleam", 36).
