...
-file("src/gleam/dynamic.gleam", 45).
?DOC(
...
-file("src/gleam/dynamic.gleam", 59).
?DOC(
...
-file("src/gleam/dynamic.gleam", 79).
?DOC(
...
-file("src/gleam/dynamic.gleam", 127).
...
-file("src/gleam/dynamic.gleam", 142).
?DOC(
...
-file("src/gleam/dynamic.gleam", 165).
?DOC(
...
-file("src/gleam/dynamic.gleam", 188).
?DOC(
...
-file("src/gleam/dynamic.gleam", 211).
?DOC(
...
-file("src/gleam/dynamic.gleam", 237).
?DOC(
...
-file("src/gleam/dynamic.gleam", 376).
?DOC(
...
-spec optional(fun((dynamic_()) -> {ok, DGZ} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(DGZ)} |
    {error, list(decode_error())}).
optional(Decode) ->
    fun(Value) -> gleam_stdlib:decode_option(Value, Decode) end.

-file("src/gleam/dynamic.gleam", 511).
...
-file("src/gleam/dynamic.gleam", 1041).
?DOC(
...
-spec any(list(fun((dynamic_()) -> {ok, DKZ} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        DKZ} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-file("src/gleam/dynamic.gleam", 1537).
...
-file("src/gleam/dynamic.gleam", 1074).
?DOC(
...
-file("src/gleam/dynamic.gleam", 583).
...
-file("src/gleam/dynamic.gleam", 274).
?DOC(
...
-spec result(
    fun((dynamic_()) -> {ok, DGN} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DGP} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {ok, DGN} | {error, DGP}} |
    {error, list(decode_error())}).
...
-file("src/gleam/dynamic.gleam", 327).
?DOC(
...
-spec list(fun((dynamic_()) -> {ok, DGU} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(DGU)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-file("src/gleam/dynamic.gleam", 106).
-spec map_errors(
    {ok, DFI} | {error, list(decode_error())},
...
-file("src/gleam/dynamic.gleam", 114).
...
-file("src/gleam/dynamic.gleam", 102).
?DOC(
...
-spec field(
    any(),
    fun((dynamic_()) -> {ok, DHJ} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, DHJ} | {error, list(decode_error())}).
...
-file("src/gleam/dynamic.gleam", 447).
?DOC(
...
-spec optional_field(
    any(),
    fun((dynamic_()) -> {ok, DHN} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@option:option(DHN)} |
    {error, list(decode_error())}).
...
-file("src/gleam/dynamic.gleam", 573).
...
-file("src/gleam/dynamic.gleam", 649).
?DOC(
...
-spec tuple2(
    ...
    fun((dynamic_()) -> {ok, DIX} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DIV, DIX}} | {error, list(decode_error())}).
...
-file("src/gleam/dynamic.gleam", 718).
?DOC(
...
) -> fun((dynamic_()) -> {ok, {DJA, DJC, DJE}} | {error, list(decode_error())}).
...
-file("src/gleam/dynamic.gleam", 789).
?DOC(
...
) -> fun((dynamic_()) -> {ok, {DJH, DJJ, DJL, DJN}} |
    {error, list(decode_error())}).
...
-file("src/gleam/dynamic.gleam", 862).
?DOC(
...
) -> fun((dynamic_()) -> {ok, {DJQ, DJS, DJU, DJW, DJY}} |
    {error, list(decode_error())}).
...
-file("src/gleam/dynamic.gleam", 937).
?DOC(
...
-spec tuple6(
    ...
    fun((dynamic_()) -> {ok, DKF} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DKH} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DKJ} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DKL} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DKB, DKD, DKF, DKH, DKJ, DKL}} |
    {error, list(decode_error())}).
...
-file("src/gleam/dynamic.gleam", 988).
?DOC(
...
-spec dict(
    ...
    fun((dynamic_()) -> {ok, DKQ} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@dict:dict(DKO, DKQ)} |
    {error, list(decode_error())}).
...
-file("src/gleam/dynamic.gleam", 1102).
?DOC(
...
-file("src/gleam/dynamic.gleam", 1134).
?DOC(
...
-spec decode3(
    fun((DLN, DLO, DLP) -> DLQ),
    fun((dynamic_()) -> {ok, DLN} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DLO} | {error, list(decode_error())}),
...
-file("src/gleam/dynamic.gleam", 1180).
?DOC(
...
-file("src/gleam/dynamic.gleam", 1236).
?DOC(
...
-spec decode5(
    fun((DMF, DMG, DMH, DMI, DMJ) -> DMK),
    fun((dynamic_()) -> {ok, DMF} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DMG} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DMH} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DMI} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DMJ} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, DMK} | {error, list(decode_error())}).
...
-file("src/gleam/dynamic.gleam", 1296).
?DOC(
...
-spec decode6(
    fun((DMR, DMS, DMT, DMU, DMV, DMW) -> DMX),
    fun((dynamic_()) -> {ok, DMR} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DMS} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DMT} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DMU} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DMV} | {error, list(decode_error())}),
...
-file("src/gleam/dynamic.gleam", 1361).
?DOC(
...
-spec decode7(
    fun((DNF, DNG, DNH, DNI, DNJ, DNK, DNL) -> DNM),
    fun((dynamic_()) -> {ok, DNF} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DNG} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DNH} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DNI} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DNJ} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DNK} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DNL} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, DNM} | {error, list(decode_error())}).
...
-file("src/gleam/dynamic.gleam", 1430).
?DOC(
...
-spec decode8(
    fun((DNV, DNW, DNX, DNY, DNZ, DOA, DOB, DOC) -> DOD),
...
-file("src/gleam/dynamic.gleam", 1503).
?DOC(
...
-spec decode9(
    fun((DON, DOO, DOP, DOQ, DOR, DOS, DOT, DOU, DOV) -> DOW),
    ...
    fun((dynamic_()) -> {ok, DOR} | {error, list(decode_error())}),
