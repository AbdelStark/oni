...
-file("src/gleam/string_builder.gleam", 52).
?DOC(
...
-file("src/gleam/string_builder.gleam", 63).
?DOC(
...
-file("src/gleam/string_builder.gleam", 22).
?DOC(
...
-file("src/gleam/string_builder.gleam", 78).
?DOC(
...
-file("src/gleam/string_builder.gleam", 90).
?DOC(
...
-file("src/gleam/string_builder.gleam", 102).
?DOC(
...
-file("src/gleam/string_builder.gleam", 30).
?DOC(
...
-file("src/gleam/string_builder.gleam", 41).
?DOC(
...
-file("src/gleam/string_builder.gleam", 115).
?DOC(
...
-file("src/gleam/string_builder.gleam", 144).
?DOC(
...
-file("src/gleam/string_builder.gleam", 155).
?DOC(
    " Converts a builder to a new builder where the contents have been\n"
    " uppercased.\n"
).
...
-file("src/gleam/string_builder.gleam", 165).
...
-file("src/gleam/string_builder.gleam", 188).
...
-file("src/gleam/string_builder.gleam", 224).
...
-file("src/gleam/string_builder.gleam", 215).
...
-file("src/gleam/string_builder.gleam", 263).
?DOC(
...
-file("src/gleam/string_builder.gleam", 290).
?DOC(
