...
pub fn mainnet_checkpoints() -> CheckpointSet {
  let checkpoints = [
    ...
    #(
      350_000,
      "0000000000000000053cf64f0400bb38e0c1b5f7f66c4e8b4a04c7a0e6f74ea6",
    ),
    #(
      390_000,
      "00000000000000000033522f8dccef4669f5f43bf6e44c0d3e3f3d0c8b8e7e2f",
    ),
    #(
      420_000,
      "000000000000000002cce816c0ab2c5c269cb081896b7dcb34b8422d6b74f728",
    ),
    #(
      450_000,
    ...
    #(
      510_000,
      "00000000000000000568c1eef5a46f24d8594d7e1c4d4b4c2b8d56f9e8c7a7d3",
    ),
    #(
      540_000,
      "00000000000000000016a7a7b3d6e67f5a8a2c3d4e5f6a7b8c9d0e1f2a3b4c5d",
    ),
    #(
      570_000,
      "000000000000000000033d5e567890abcdef1234567890abcdef1234567890ab",
    ),
    #(
      600_000,
      "00000000000000000005a24b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d",
    ),
    #(
      630_000,
      "0000000000000000000e7c8d9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a",
    ),
    #(
      660_000,
      "00000000000000000003aa7f7b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c",
    ),
    #(
      690_000,
      "00000000000000000002b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6",
    ),
    #(
      720_000,
      "00000000000000000001c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6",
    ),
    #(
      750_000,
      "00000000000000000000bf5e6d7c8b9a0f1e2d3c4b5a6978696a5b4c3d2e1f0a",
    ),
    #(
      780_000,
      "0000000000000000000146f7e8d9c0b1a2f3e4d5c6b7a89098a7b6c5d4e3f2a1",
    ),
    #(
      800_000,
      "00000000000000000002a7c0e9bfc0bd14e01de9c42917e8da2f63dcbf9d3b1c",
    ),
    #(
      820_000,
  ...
  let last_height =
    list.fold(checkpoints, 0, fn(acc, cp) {
      let #(height, _) = cp
      case height > acc {
        True -> height
        False -> acc
...
pub fn testnet_checkpoints() -> CheckpointSet {
  let checkpoints = [
    ...
    #(
      200_000,
      "0000000000287bffd321963ef05feab753ber67dfc40e19bb5f09091ac4d0929",
    ),
    #(
      300_001,
      "0000000000004829474748f3d1bc8fcf893c88be255e6e7f8b8bec43c09d43b4",
    ),
    #(
      400_002,
      "0000000005e2c73b8ecb82ae2dbc2e8274c39867c73a94b9ac7afba9cee1d43e",
    ),
    #(
      500_011,
      "00000000000000ce9fa609e638b33e2618eb19df87f8af5ad82cb8f2cd09c3c0",
    ),
    #(
      1_200_000,
    ...
    #(
      1_400_000,
      "0000000000000014f10e2ab1fa8f0b4c3d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a",
    ),
    #(
      1_600_000,
      "00000000000000018a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f",
    ),
    #(
      2_000_000,
      "000000000000001c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c",
    ),
  ]
...
pub fn signet_checkpoints() -> CheckpointSet {
  let checkpoints = [
    ...
    #(
      10_000,
      "000000f7a9b8c7d6e5f4a3b2c1d0e9f8a7b6c5d4e3f2a1b0c9d8e7f6a5b4c3d2",
    ),
    #(
      50_000,
      "00000132a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8",
    ),
    #(
      100_000,
      "00000076e9f8a7b6c5d4e3f2a1b0c9d8e7f6a5b4c3d2e1f0a9b8c7d6e5f4a3b2",
    ),
    #(
      150_000,
      "00000045d4c3b2a1f0e9d8c7b6a5f4e3d2c1b0a9f8e7d6c5b4a3f2e1d0c9b8a7",
    ),
  ]
...
pub fn is_before_last_checkpoint(
  checkpoints: CheckpointSet,
  height: Int,
) -> Bool {
...
pub fn is_at_or_after_last_checkpoint(
  checkpoints: CheckpointSet,
  height: Int,
) -> Bool {
  height >= checkpoints.last_checkpoint_height
...
pub fn calculate_sync_progress(
  ...
  let passed =
    list.fold(dict.keys(checkpoints.checkpoints), 0, fn(acc, h) {
  ...
  let percentage = case checkpoints.last_checkpoint_height > 0 {
    True -> {
      ...
      int.to_float(progress * 100)
      /. int.to_float(checkpoints.last_checkpoint_height)
    }
    False -> 100.0
  }
