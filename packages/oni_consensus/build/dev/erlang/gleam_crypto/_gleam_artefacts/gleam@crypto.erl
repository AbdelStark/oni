...
-type hash_algorithm() :: sha224 | sha256 | sha384 | sha512 | md5.
...
-file("src/gleam/crypto.gleam", 36).
?DOC(" Computes a digest of the input bit string.\n").
-spec hash(hash_algorithm(), bitstring()) -> bitstring().
hash(A, B) ->
    crypto:hash(A, B).

-file("src/gleam/crypto.gleam", 47).
?DOC(
...
-file("src/gleam/crypto.gleam", 60).
...
-file("src/gleam/crypto.gleam", 53).
?DOC(
...
-file("src/gleam/crypto.gleam", 90).
...
-file("src/gleam/crypto.gleam", 79).
?DOC(
...
-file("src/gleam/crypto.gleam", 109).
