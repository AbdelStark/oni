...
-file("src/gleam/string.gleam", 24).
?DOC(
...
-file("src/gleam/string.gleam", 50).
?DOC(
...
-file("src/gleam/string.gleam", 70).
?DOC(
    " Reverses a `String`.\n"
    "\n"
...
-file("src/gleam/string.gleam", 104).
?DOC(
...
-file("src/gleam/string.gleam", 147).
?DOC(
    " Creates a new `String` with all the graphemes in the input `String` converted to\n"
    " uppercase.\n"
    "\n"
...
-file("src/gleam/string.gleam", 171).
?DOC(
...
-file("src/gleam/string.gleam", 324).
?DOC(
...
-file("src/gleam/string.gleam", 341).
?DOC(
...
-file("src/gleam/string.gleam", 397).
...
-file("src/gleam/string.gleam", 487).
...
-file("src/gleam/string.gleam", 482).
?DOC(
...
-file("src/gleam/string.gleam", 580).
-spec do_trim(binary()) -> binary().
do_trim(String) ->
    string:trim(String, both).

-file("src/gleam/string.gleam", 575).
?DOC(
...
-file("src/gleam/string.gleam", 613).
-spec do_trim_left(binary()) -> binary().
do_trim_left(String) ->
    string:trim(String, leading).

-file("src/gleam/string.gleam", 608).
?DOC(
...
-file("src/gleam/string.gleam", 635).
...
-file("src/gleam/string.gleam", 662).
?DOC(
...
-file("src/gleam/string.gleam", 679).
?DOC(
...
-file("src/gleam/string.gleam", 216).
?DOC(
...
-file("src/gleam/string.gleam", 269).
?DOC(
...
-file("src/gleam/string.gleam", 285).
?DOC(
...
-file("src/gleam/string.gleam", 358).
?DOC(
...
-file("src/gleam/string.gleam", 512).
?DOC(
...
-file("src/gleam/string.gleam", 544).
?DOC(
...
-file("src/gleam/string.gleam", 732).
...
-file("src/gleam/string.gleam", 726).
...
-file("src/gleam/string.gleam", 772).
?DOC(
...
-file("src/gleam/string.gleam", 797).
?DOC(
...
-file("src/gleam/string.gleam", 843).
?DOC(
...
-file("src/gleam/string.gleam", 866).
?DOC(
...
-file("src/gleam/string.gleam", 884).
?DOC(
...
-file("src/gleam/string.gleam", 916).
?DOC(
