...
-file("src/gleam/option.gleam", 12).
...
-file("src/gleam/option.gleam", 43).
?DOC(
...
-file("src/gleam/option.gleam", 61).
?DOC(
...
-file("src/gleam/option.gleam", 79).
?DOC(
...
-file("src/gleam/option.gleam", 97).
?DOC(
...
-file("src/gleam/option.gleam", 118).
?DOC(
...
-file("src/gleam/option.gleam", 139).
?DOC(
...
-file("src/gleam/option.gleam", 160).
?DOC(
...
-file("src/gleam/option.gleam", 185).
?DOC(
...
-file("src/gleam/option.gleam", 250).
?DOC(
    " Updates a value held within the `Some` of an `Option` by calling a given function\n"
...
-file("src/gleam/option.gleam", 281).
?DOC(
...
-file("src/gleam/option.gleam", 312).
?DOC(
...
-file("src/gleam/option.gleam", 319).
...
-file("src/gleam/option.gleam", 344).
?DOC(
